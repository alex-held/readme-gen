...
describe('askProjectPrerequisites', () => {
    it('should return correct question format', () => {
        ...
        const result = project_prerequisites_1.default(projectInfos);
    ...
    it('should not show the question when engines property is empty object', () => {
        const projectInfos = { engines: {} };
        const question = project_prerequisites_1.default(projectInfos);
...
//# sourceMappingURL=project-prerequisites.spec.js.map